...
RetentionScience.prototype.setDefaults = function(facade){
  console.log(facade);
  console.log(facade.userId());
  console.log(facade.email());
  window._rsq.push(['_setSiteId', this.options.siteId]);
  if (this.options.enableOnSite) {
    window._rsq.push(['_enableOnSite']);
  };
  window._rsq.push(['_setUserId', facade.userId()]);
  window._rsq.push(['_setUserEmail', facade.email()]);
};
